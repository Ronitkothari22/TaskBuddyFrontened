      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.headerContainer}>
          <Text style={styles.headerText}>
            Get Started with TaskBuddy <Sparkles size={24} color="#FF007A" />
          </Text>
        ...
        <View style={styles.formContainer}>
          <View style={styles.inputContainer}>
            <Mail size={20} color="#00FFD1" style={styles.inputIcon} />
            <TextInput
              style={styles.input}
              placeholder="Email"
          ...
          <View style={styles.inputContainer}>
            <Lock size={20} color="#00FFD1" style={styles.inputIcon} />
            <TextInput
              style={styles.input}
